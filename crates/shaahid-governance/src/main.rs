...
"#,
        ...
        workspace.write_root_manifest_members(&["shaahid-contract", "shaahid-governance", "tokio"]);
    ...
    fn core_io_call_is_rejected() {
        ...
        workspace.write_package("shaahid-governance", "");
        workspace.write_root_manifest_members(&["shaahid-contract", "shaahid-governance"]);
