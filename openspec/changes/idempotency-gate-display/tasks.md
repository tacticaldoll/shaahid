...
- [x] 1.1 In `idempotency_gate_resolves_four_trajectories`, replace the manual
...
- [x] 1.2 Assert that each quarantined trajectory produced a non-empty `Display` message
...
- [x] 2.1 Run the full Definition of Done from `AGENTS.md` and confirm all gates pass,
